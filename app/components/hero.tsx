     ...
     >
       <div className="mx-auto flex w-full max-w-6xl flex-col gap-16 md:flex-row md:items-end">
         ...
         >
          ...
          <button className="mt-2 rounded-full border-2 border-white/30 bg-white/10 px-10 py-4 text-[0.75rem] font-semibold uppercase tracking-[0.3em] text-white backdrop-blur-sm transition-all hover:border-white/50 hover:bg-white/15 hover:scale-105">
            Join the Drop
          </button>
         </motion.div>
       </div>
